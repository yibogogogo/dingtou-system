...
for key in ['kc50', 'zxhl', 'hldb']:
    # 使用带趋势的随机游走
    trend = 0.0005 if key == 'kc50' else 0.0003
    prices = 1000 * np.exp(np.cumsum(np.random.normal(trend, 0.02, len(dates))))
...
print('=== Fixed Backtest Results (2022-2026) ===')
